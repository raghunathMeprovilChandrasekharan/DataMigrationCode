...
/**
 * <p>Java class for complexType.ThresholdRefinementBucket complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="complexType.ThresholdRefinementBucket">
 *   &lt;complexContent>
 ...
 *         &lt;element name="threshold" type="{http://www.demandware.com/xml/impex/catalog/2006-10-31}sharedType.LocalizedText" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "complexType.ThresholdRefinementBucket", propOrder = {
    "displayName",
    "threshold",
    "presentationId",
    "description"
})
public class ComplexTypeThresholdRefinementBucket {

    @XmlElement(name = "display-name")
    protected List<SharedTypeLocalizedString> displayName;
    protected List<SharedTypeLocalizedText> threshold;
     ...
     * 
     */
    public List<SharedTypeLocalizedText> getThreshold() {
        if (threshold == null) {
            threshold = new ArrayList<SharedTypeLocalizedText>();
        }
