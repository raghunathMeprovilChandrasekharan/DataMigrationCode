...
/**
 * <p>Java class for complexType.AttributeRefinementBucket complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="complexType.AttributeRefinementBucket">
 *   &lt;complexContent>
 ...
 *         &lt;element name="value-list" type="{http://www.demandware.com/xml/impex/catalog/2006-10-31}sharedType.LocalizedText" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "complexType.AttributeRefinementBucket", propOrder = {
    "displayName",
    "valueList",
    "presentationId",
    "description"
})
public class ComplexTypeAttributeRefinementBucket {

    @XmlElement(name = "display-name")
    protected List<SharedTypeLocalizedString> displayName;
    @XmlElement(name = "value-list")
    protected List<SharedTypeLocalizedText> valueList;
     ...
     * 
     */
    public List<SharedTypeLocalizedText> getValueList() {
        if (valueList == null) {
            valueList = new ArrayList<SharedTypeLocalizedText>();
        }
